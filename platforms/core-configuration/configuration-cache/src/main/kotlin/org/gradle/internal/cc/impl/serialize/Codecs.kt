...
class Codecs(
    ...
    private
    val globalFileCollectionFactory = fileCollectionFactory.withResolver(fileLookup.fileResolver)
    ...
    init {
        fun makeUserTypeBindings(providersBlock: BindingsBuilder.() -> Unit) = Bindings.of {
            ...
            fileCollectionTypes(directoryFileTreeFactory, globalFileCollectionFactory, artifactSetConverter, fileOperations, fileFactory, patternSetFactory, fileLookup)
